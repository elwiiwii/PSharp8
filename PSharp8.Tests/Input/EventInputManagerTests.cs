#pragma warning disable CS0618 // EventInputManager is obsolete — this file tests the deprecated event path
...
public class EventInputManagerTests
{
    // --------------------------------------------------------------------------
    #region Helpers
    // --------------------------------------------------------------------------

    private static EventInputManager CreateSut(InputBindings? bindings = null, BtnpConfig? config = null)
    ...
    {
        var act = () => new EventInputManager(bindings: null!);
